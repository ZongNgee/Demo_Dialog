...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnDemo, btnDemo2, btnDemo3, btnEx3, btnDemo4, btnDemo5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEx3 = findViewById(R.id.buttonDemo4);
        btnDemo4 = findViewById(R.id.buttonDemo5);
        btnDemo5 = findViewById(R.id.buttonDemo6);
        ...
        btnEx3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // Extract the text entered by the user
                        String first = etInput.getText().toString();
                        String second = etInput2.getText().toString();
                        int firsts = new Integer(first).intValue();
                        int seconds = new Integer(second).intValue();
                        int total = firsts + seconds;
                        // Set the text to the TextView
                        tv3.setText("The sum is " + total);
                    }
                });
                myBuilder.setNegativeButton("CANCEL", null);
                AlertDialog myDialog = myBuilder.create();
